...
class ProcessingResult(BaseModel):
    """Result of the research processing operation."""
...
class ResearchDataManager:
    """Simple in-memory manager for research operations."""
    
    def __init__(self):
        self.processing_results: Dict[str, ProcessingResult] = {}
        self.research_sources: Dict[str, ResearchSource] = {}
        
    def store_processing_result(self, directory: str, result: ProcessingResult):
    ...
    def get_research_source(self, source_id: str) -> Optional[ResearchSource]:
        ...
        return self.reserch_sources.get(source_id)
